...
class _OrderPageState extends State<OrderPage> {
            ...
            onPressed: () async {
              if (await Internet.checkConnection()) {
                if (initData['order_data'] == null) {
                  ...
                  var answer = await getStatusOrder(status,
    ...
    if (initData['order_data'] == null) {
      ...
      if (initData['order_data']['order']['tariff']['total_price'] <
          initData['order_data']['order']['tariff']
              ['guaranteed_driver_income']) {
        guarantPrice = initData['order_data']['order']['tariff']
            ['guaranteed_driver_income'];
      } else {
      ...
      buttonIndex = 2;
      if (initData['order_data']['order']['routes'][0]['category'] ==
          'Рестораны') {
        category = 'ресторана';
      } else if (initData['order_data']['order']['routes'][0]['category'] ==
          'Аптеки') {
        category = 'аптеки';
      } else if (initData['order_data']['order']['routes'][0]['category'] ==
          'Магазины') {
      ...
      switch (deliverStatus) {
        case 'order_start':
          ...
          break;
        case 'on_place':
          switchToClient = (initData['order_data']['order']['client']
                      ['comment'])
                  .contains(new RegExp(r'[A-Za-z0-9а-яА-Я]'))
              ? "Комментарий клиента:"
              : switchToClient;
          orderComment = (initData['order_data']['order']['client']['comment'])
                  .contains(new RegExp(r'[A-Za-z0-9а-яА-Я]'))
              ? initData['order_data']['order']['client']['comment']
              : null;
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: FutureBuilder(
          future: initData['order_data'] == null
              ? getDetailOrdersData(orders[chosenIndex]['offer']['uuid'])
              : deliverInitData(),
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Text(
                                              orderDetail['order']['tariff']
                                                  ...
                                                  : "Сумма выкупа: ${orderDetail['order']['tariff']['products_price']}₽\nВзять с клиента: ${orderDetail['order']['tariff']['products_price'] + orderDetail['order']['tariff']['total_price'] - orderDetail['order']['tariff']['bonus_payment']}₽\n$feature",
                                              style: TextStyle(
                                                color: Colors.black,
                                                fontSize: 14.0,
                                                fontWeight: FontWeight.bold,
                                          ...
                                          Container(
                                            width: MediaQuery.of(context)
                                                ...
                                                .4,
                                            child: Text(
                                              "Ваш заработок: $guarantPrice₽\n\nПоступят на курьерский баланс: ${orderDetail['order']['tariff']['bonus_payment']}₽",
                                              style: TextStyle(
                                                color: Colors.black,
                                                fontSize: 14.0,
                                                fontWeight: FontWeight.bold,
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                            Container(
                                                                          child:
                                                                              Text("Пожалуйста, укажите максимально точное время прибытия к клиенту"),
                                                                        ),
                                                                      ),
                                                                    ],
                                                                  ),
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Text(
                                              initData['order_data']['order']
                                                  ...
                                                  : "Сумма выкупа: ${initData['order_data']['order']['tariff']['products_price']}₽\nВзять с клиента: ${initData['order_data']['order']['tariff']['products_price'] + initData['order_data']['order']['tariff']['total_price'] - initData['order_data']['order']['tariff']['bonus_payment']}₽\n\n$feature",
                                              style: TextStyle(
                                                color: Colors.black,
                                                fontSize: 14.0,
                                                fontWeight: FontWeight.bold,
                                          ...
                                          Container(
                                            width: MediaQuery.of(context)
                                                ...
                                                .4,
                                            child: Text(
                                              "Ваш заработок: $guarantPrice₽\n\nПоступят на курьерский баланс: ${initData['order_data']['order']['tariff']['bonus_payment']}₽",
                                              style: TextStyle(
                                                color: Colors.black,
                                                fontSize: 14.0,
                                                fontWeight: FontWeight.bold,
