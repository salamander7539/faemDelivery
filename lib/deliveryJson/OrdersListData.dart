...
//
//     final ordersListData = ordersListDataFromJson(jsonString);

import 'dart:convert';

List<OrdersListData> ordersListDataFromJson(String str) => List<OrdersListData>.from(json.decode(str).map((x) => OrdersListData.fromJson(x)));

String ordersListDataToJson(List<OrdersListData> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class OrdersListData {
  ...
  factory OrdersListData.fromJson(Map<String, dynamic> json) => OrdersListData(
...
class OrderTaxiParkData {
  ...
  final String name;
  final String comment;
  final List<String> friendlyUuid;
  final List<dynamic> unwantedUuid;
  final String regionUuid;
  final Representative representative;
  ...
  factory OrderTaxiParkData.fromJson(Map<String, dynamic> json) => OrderTaxiParkData(
    ...
    name: json["name"],
    comment: json["comment"],
    friendlyUuid: List<String>.from(json["friendly_uuid"].map((x) => x)),
    unwantedUuid: List<dynamic>.from(json["unwanted_uuid"].map((x) => x)),
    regionUuid: json["region_uuid"],
    representative: Representative.fromJson(json["representative"]),
  );
